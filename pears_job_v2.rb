class PearsVoters
  ...
  USER_AGENTS = [
    ...
    "Mozilla/5.0 (X11; CrOS x86_64 8172.45.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.64 Safari/537",
  ...
  def vote
    RestClient::Request.new({
      ...
      url: @end_point,
      payload: payload,
      headers: header}).execute do |response, request, result|
        case response.code
        when 500
          {status: false, message: "Internal Server Error!"}
        when 200
            {status: true, message: "Vote Accepted!"}
        else
  ...
  def header
    {
      ...
      "Referer" => 'https://pearsbaby.ng/pears-baby-of-the-year-2019/?contest=photo-detail&photo_id=18998',
      "Content-Type" => 'application/x-www-form-urlencoded; charset=UTF-8',
      "X-Requested-With" => 'XMLHttpRequest',
      "Content-Length" => 72,
      "Connection" => 'close',
      "Cookie" => 'catAccCookies=1'
    }
  end
end

def job
  voter = PearsVoters.new
  response = voter.vote
end
